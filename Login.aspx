...
<body>
    <form id="form1" runat="server">
        <asp:Login ID="UserLOGIN" runat="server" BackColor="#F7F6F3" BorderColor="Black" BorderPadding="4" BorderStyle="Outset" BorderWidth="3px" Font-Names="Verdana" Font-Size="1.2em" ForeColor="#333333" OnAuthenticate="UserLogin_Authenticate" Height="300px" Width="700px" DisplayRememberMe="False" RememberMeText="Remember Me" FailureText="Invalid Login, Please Check User Name &amp; Password">
