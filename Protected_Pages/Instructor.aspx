...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:GridView ID="MembersGRID" runat="server" CellPadding="4" CssClass="auto-style1" ForeColor="#333333" GridLines="None" Width="800px" style="margin-left: 120px" AutoGenerateColumns="False" Height="300px">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="firstName" HeaderText="Member First Name:">
                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Font-Size="X-Large" />
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Font-Size="Larger" />
                            </asp:BoundField>
                            <asp:BoundField DataField="lastName" HeaderText="Member Last Name:">
                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Font-Size="X-Large" />
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Font-Size="Larger" />
                            </asp:BoundField>
                        </Columns>
